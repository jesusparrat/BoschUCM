...
if(((linefollower_center_left.readSensor() == WHITE))  &&  ((linefollower_center_right.readSensor() == BLACK))){
 ...
 if((linefollower_ext_left.readSensor() == HIGH)  ||  (linefollower_ext_right.readSensor() == HIGH)){
          ...
          int direccion = communicationManager->ReadMsg();
          communicationManager->WaitForMsg(direccion);

          
          if (direccion == LEFT) { // si lee extremo izquierda, extremo derecha y los dos del centro, todo en negro, que elija derecha 
            forward(25);
            delay(10);
            _stop(0);
            delay(50);
          ...
          } else if (direccion == RIGHT){  // si lee extremo izquierda, extremo derecha y los dos del centro, todo en negro, que elija izquierda 
          ...
          } else if (direccion == TURN180){  // si lee extremo izquierda, extremo derecha y los dos del centro, todo en negro, que elija volver hacia atrás 
          ...
          } else if (direccion == NOSTOP){  // si lee extremo izquierda, extremo derecha y los dos del centro, todo en negro, que elija seguir el rumbo 
